...
You are **Person A**. You draw a random card that only you can see. Then you convince **Person B** of the card's colour — without showing it, and without revealing which card of that colour it is. You can also try to cheat, to see that a false claim fails.
...
3. To prove the hidden card's colour honestly, you show Person B **all four cards of the other colour**. Drew red? Show the four blacks. Drew black? Show the four reds.
...
5. Or choose **Try to cheat**: claim the opposite colour. You can only produce three cards of the colour the lie requires, so Person B rejects the claim. That is soundness.
